...
import { ContactCloserProps } from ".";

const ContactCloser: React.FC<ContactCloserProps> = (props) => {
  const {
    title,
    description,
    buttonText,
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          style={{ backgroundColor: mainColor ?? "#3B82F6" }}
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <input
                ...
                style={{
                  backgroundColor: `${textColor ?? "#000000"}10`,
                  color: textColor ?? "#000000",
                  borderWidth: "2px",
                  borderColor: `${mainColor ?? "#3B82F6"}30`,
                }}
              />
            </div>
            <div className="relative">
        ...
        >
          {email && (
            <motion.a
              ...
              style={{
                backgroundColor: `${mainColor ?? "#3B82F6"}15`,
                color: mainColor ?? "#3B82F6",
                borderWidth: "2px",
                borderColor: mainColor ?? "#3B82F6",
              }}
            >
              <Mail size={22} />
              {email}
