...
const Testimonials3: React.FC<Testimonials3Props> = (props) => {
  ...
  const colors = deriveColorPalette({
    ...
    baseBgColor: baseBgColor ?? "#ffffff",
    mainColor: mainColor ?? "#00bfff",
    bgLayout: bgLayout as GradientConfig ?? { type: "solid" },
  });

  const background = useAnimatedGradient(bgLayout as GradientConfig ?? { type: "solid" }, colors);
